...
export const knowledgeApi = {
  ...
  extractSkeleton: (graphId: number, text: string) => request.post(`/api/knowledge/graphs/${graphId}/extract-skeleton`, { text }),
  autoAttach: (graphId: number, text: string) => request.post(`/api/knowledge/graphs/${graphId}/auto-attach`, { text }),
